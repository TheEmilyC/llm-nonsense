...
import { lorebookDbFormSchema, LorebookDbFormValues } from "@/app/lorebook/_lib/schema";
...
export function LorebookForm({ formId, defaultValues, onSubmit }: LorebookFormProps) {
  const form = useForm<LorebookDbFormValues>({
    resolver: zodResolver(lorebookDbFormSchema),
    mode: "onTouched",
    defaultValues: defaultValues || { name: "", apiKey: "" },
  });
